...
from scanpy.plotting._anndata import _check_var_names_type, _prepare_dataframe, _reorder_categories_after_dendrogram, _plot_colorbar, _plot_categories_as_colorblocks, _plot_dendrogram, _plot_gene_groups_brackets
from scanpy.plotting._utils import _dk, check_colornorm
...
from typing import Literal
    ...
    # swap axes case
        ...
        if dendrogram:
            ...
            scp.pl._anndata._plot_dendrogram(
                dendro_ax,
                adata,
                groupby,
                dendrogram_key=_dk(dendrogram),
        ...
        # plot colorbar
        scp.pl._anndata._plot_colorbar(im, fig, axs[1, 2])
    ...
    show = scp.settings.autoshow if show is None else show

    return fig, return_ax_dict